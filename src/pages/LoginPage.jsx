...
import { loginUser, clearError, selectAuthError, selectIsAuth } from '../store/authSlice'
...
export default function LoginPage() {
  ...
  useEffect(() => { if (isAuth) navigate('/home') }, [isAuth])
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(loginUser({ email: form.email.trim().toLowerCase(), password: form.password }))
    setLoading(false)
  }
    ...
    <div className="min-h-screen bg-[#0d0d0d] flex">
      ...
      <div className="hidden lg:flex flex-col w-1/2 bg-[#111] border-r border-white/8 p-12 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <span className="font-heading font-bold text-2xl">Sky<span className="text-volt">Mart</span></span>
        </div>
